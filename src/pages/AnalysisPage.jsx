...
export default function AnalysisPage() {
  ...
  const askQuestion = async () => {
    ...
    try {
      const res = await axios.post("https://legalmindai-backend.onrender.com/api/qna", {
...
const toggleListening = () => {
  ...
  try {
    const response = await axios.post("https://legalmindai-backend.onrender.com/api/negotiation", {
